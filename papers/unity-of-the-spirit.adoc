...
It turns out that this title expands our horizons beyond just the earth.
...
We’re learning about Christ’s Identity.
At the same time we’re learning about our own identity.

Ultimately, the Father's goal of Oneness ends with God being all in all.
