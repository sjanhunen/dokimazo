...
For example, body can simply mean a flesh and blood natural body like we have and like the one Adam had.
...
Finally, body is used to describe a call out group of individuals that are all related.
This is most of then the sense of the word when we say the "body of Christ."
...
We're referring to the "the church.""

Body used in this way is very much a concept that belongs to the teaching of Paul.
