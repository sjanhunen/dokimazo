...
When we think about the word baptize, death is certainly not the first association that jumps to mind.
...
Another frequent theme that appears along side Paul's teaching on baptism is the cross.
In fact, in most places that Paul mentions baptism he also mentions the cross.
If we think about Christ, the cross was how His baptism into death was accomplished.
...
Paul provides extensive teaching on both baptism and the new creation in 1 Corinthians.
Paul explains and contrasts each of the three baptisms in this book.
He also compares the old creation to the new creation at length.
You might say that these are major themes in the book.
There are a number of really practical issues Paul is trying to deal with and correct in this letter.
But at the root of these issues lies a lack of understanding and embracing baptism into the death of Christ.

A brief outline of 1 Corinthians:
...
- Ch 13-14: Follow after love, without this, the spirit gifts are nothing
