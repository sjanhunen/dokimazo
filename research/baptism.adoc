...
Paul explains and contrasts each of the three baptims in this book.
He also compares the old creation to the new creation at length.
You might say that these are major themes in the book.
Yes, there are a bunch of issues Paul is trying to deal with and correct in this letter, but at the root of these issues lies a lack of embracing baptism into the death of Christ and the new creation.
