...
Paul is asking: why would someone be baptized "for the dead" if there is no resurrection.
What does being baptized "for the dead" mean?
The phrase in the greek can mean over as in position or in place of.
...
It is much more likely that this is referring to the baptism Christ was baptized with.
