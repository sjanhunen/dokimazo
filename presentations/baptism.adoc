...
Christ Buried + Christ Raised = I am buried + I am raised
...
1. Adam as head (Romans)
2. Adam & Eve as one body (Genesis & Ephesians)
3. Nations & Israel (Genesis)

== The New Creation

1. Christ as Head (Ephesians)
2. Christ & The Church as One Body (Ephesians)
3. The Husband & The Bride (Ephesians & Revelation)
